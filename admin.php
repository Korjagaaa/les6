...
$json = "json";
$file_dir = './tests.';
$files = glob('/var/www/user_data/franchuk/me/PHP/les6/tests/*.json');
$fileLast = end($files);
...
if (isset($_FILES['myfile']['name']) && !empty($_FILES['myfile']['name'])) {
    ...
    if ($explode[1] !== $json) {
        ...
        if ($_FILES['myfile']['error'] == UPLOAD_ERR_OK && move_uploaded_file($_FILES['myfile']['tmp_name'], "/var/www/user_data/franchuk/me/PHP/les6/tests/$fileNew")) {
